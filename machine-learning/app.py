...
app.title = "Surface Material Detector"
server = app.server
                                ...
                                drc.Card(
                                    ...
                                    children=[
                                        drc.NamedDropdown(
                                            ...
                                            options=[
                                                {"label": "SiO4", "value": "moons"},
                                                {"label": "H20", "value": "circles"},
                                                {"label": "Fe3O4", "value": "linear"}
                                            ],
                                            clearable=False,
                                            searchable=False,
                                            value="moons",
...
def update_svm_graph(
    ...
    prediction_figure = figs.serve_prediction_plot(
        ...
        mesh_step=h,
        threshold=threshold,
        image=app.get_asset_url('images/radio_moon_surface_nasa.jpg')
    )
